 ...
 */
package org.assignment.test.setup;
...
import org.assignment.test.constants.NagaccTestConstants;
import org.assignment.test.orders.AcceleratorTestOrderData;
...
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			LOG.info("Creating site impex...");
			importImpexFile(context, "/nagacctest/import/site.impex");

			LOG.info("Creating site responsive impex...");
			importImpexFile(context, "/nagacctest/import/site-responsive.impex");

			LOG.info("Creating store.impex ...");
			importImpexFile(context, "/nagacctest/import/store.impex");

			LOG.info("Creating store responsive .impex...");
			importImpexFile(context, "/nagacctest/import/store-responsive.impex");
